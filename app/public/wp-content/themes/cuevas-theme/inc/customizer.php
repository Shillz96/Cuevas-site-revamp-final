...
function cuevas_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'cuevas_nav_transparent', array(
		'default'           => true,
		'sanitize_callback' => 'cuevas_sanitize_checkbox',
	) );
	
	$wp_customize->add_control( 'cuevas_nav_transparent', array(
		'label'       => __( 'Transparent Navigation on Home', 'cuevas' ),
		'description' => __( 'Make the navigation transparent on the homepage', 'cuevas' ),
		'section'     => 'cuevas_navigation_section',
		'type'        => 'checkbox',
	) );
