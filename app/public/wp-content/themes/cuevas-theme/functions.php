...
function cuevas_scripts() {
	...
	wp_enqueue_script( 'cuevas-animations', get_template_directory_uri() . '/assets/js/animations.js', array('gsap', 'gsap-scroll-trigger', 'gsap-scrollto'), CUEVAS_VERSION, true );
