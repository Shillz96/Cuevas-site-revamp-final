...
/**
 * Manages mock products for the Cuevas theme.
 */
class Cuevas_Mock_Products_Command {
    private $image_dir;
    
    public function __construct() {
        $this->image_dir = WP_CONTENT_DIR . '/../../../Featured prodcuts/';
    }
    
    /**
     * Adds mock products with images
     *
     * ## OPTIONS
     *
     * [--force]
     * : Override existing products
     *
     * ## EXAMPLES
     *
     *     wp cuevas mock-products add
     *     wp cuevas mock-products add --force
     */
    public function add($args, $assoc_args) {
        ...
        foreach ($mock_products as $product_data) {
            ...
            if ($existing_product && !$force) {
                WP_CLI::warning("Product '{$product_data['name']}' already exists. Use --force to update.");
                $progress->tick();
                continue;
            }
            ...
            if ($product_data['image']) {
                ...
                if (file_exists($image_path)) {
                    ...
                    WP_CLI::warning("Image not found: $image_path");
                }
            }
...
WP_CLI::add_command('cuevas mock-products', 'Cuevas_Mock_Products_Command'); 